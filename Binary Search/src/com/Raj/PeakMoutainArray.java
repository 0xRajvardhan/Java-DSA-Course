    ...
    public int peakIndexInMountainArray(int[] arr) {
        ...
        while (start < end) {
            ...
            if (arr[mid] > arr[mid + 1]) {
                // you are in a dec part of the array
        ...
        // in the end,  start == end and pointing to the larget number because of the 2 checks above
        // start and end are always trying to find the max number in the above 2 checks
